import { blurPage } from "./modules/blurPage.js";
import { hideMobileMenu } from "./modules/showMobileMenu.js";
import { itemList } from "../product items/itemList.js";
import { shoppingCart } from "../product items/shoppingCart.js";
import { mappingShoppingCart } from "./modules/shopping cart modules/mappingShoppingCart.js";
import { ShoppingCartSection } from "./modules/ShoppingCartSection.js";

// mapping shopping cart
const body = document.querySelector("body");
body.appendChild(mappingShoppingCart());
